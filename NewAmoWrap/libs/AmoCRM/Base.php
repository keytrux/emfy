...
abstract class Base
{
     ...
     */
    public static function cUrl($url, $data = array(), DateTime $modifiedSince = null, $ajax = false, $method = 'GET')
    {
        $url = 'https://' . self::$domain . '.amocrm.ru/' . $url;

        $curl = curl_init();
        curl_setopt($curl,CURLOPT_RETURNTRANSFER, true);
        curl_setopt($curl,CURLOPT_USERAGENT,'AmoCRM_Wrap/v' . AmoCRM::VERSION);
